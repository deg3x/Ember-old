...
void EditorTheme::ApplyTheme()
{
    ...
    colors[ImGuiCol_Separator]              = ImVec4(0.40f, 0.40f, 0.40f, 0.20f);
    colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.65f, 0.65f, 0.65f, 0.20f);
    colors[ImGuiCol_SeparatorActive]        = ImVec4(0.40f, 0.44f, 0.47f, 1.00f);
    colors[ImGuiCol_ResizeGrip]             = ImVec4(0.28f, 0.28f, 0.28f, 0.29f);
    colors[ImGuiCol_ResizeGripHovered]      = ImVec4(0.44f, 0.44f, 0.44f, 0.29f);
    colors[ImGuiCol_ResizeGripActive]       = ImVec4(0.40f, 0.44f, 0.47f, 1.00f);
    colors[ImGuiCol_Tab]                    = ImVec4(0.00f, 0.00f, 0.00f, 0.55f);
    colors[ImGuiCol_TabHovered]             = ImVec4(0.15f, 0.60f, 0.50f, 0.80f);
    colors[ImGuiCol_TabActive]              = ImVec4(0.10f, 0.55f, 0.45f, 1.00f);
    ...
    colors[ImGuiCol_TableRowBgAlt]          = ImVec4(0.00f, 0.00f, 0.00f, 0.15f);
